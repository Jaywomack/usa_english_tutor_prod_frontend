          ...
          <div class="container px-5 py-24 mx-auto">
            <div class="flex flex-col text-center w-full mb-20">
              ...
              <p class="lg:w-2/3 mx-auto leading-relaxed text-base lg:text-xl">
                We offer a wide array of lessons and services that will help you
            ...
            <div class="flex flex-wrap">
              <div class="xl:w-1/4 lg:w-1/2 md:w-full px-8 py-6 border-l-2 border-gray-200 border-opacity-60">
                ...
                <p class="leading-relaxed text-base mb-4">
                  Get custom tailored lessons to improve your IELTS scores with
                  a tutor who specializes in IELTS training and tutoring that
                  will work with you 1 on 1. Master the IELTS with USA English
                  Tutor.
                </p>
                <Link href="/tutors">
              ...
              <div class="xl:w-1/4 lg:w-1/2 md:w-full px-8 py-6 border-l-2 border-gray-200 border-opacity-60">
                ...
                <p class="leading-relaxed text-base mb-4">
                  Book Business English lessons and help improve your ability to
                  work in the world economy and improve your business
              ...
              <div class="xl:w-1/4 lg:w-1/2 md:w-full px-8 py-6 border-l-2 border-gray-200 border-opacity-60">
                ...
                <p class="leading-relaxed text-base mb-4">
                  ...
                  presentation on a specific subject. We tailor these events to
                  the clients needs and are open to speaking about a wide array
                  of subjects.
                </p>
                <Link href="/tutors">
                  <a class="text-indigo-500 inline-flex items-center">
